...
메이저한 검색봇에게 정상적으로 크롤링 되어야하는 것과 일맥상통합니다. 그렇기 때문에
...
Next.js에서는 다양한 방법으로 sitemap.xml을 생성할 수 있습니다.
[globby](https://www.npmjs.com/package/globby)를 활용해서 pages 디렉토리 내의 파일명들로 sitemap을 제작하는 방법도 있지만
보다 손쉽게 [next-sitemap](https://www.npmjs.com/package/next-sitemap) 사용해 아래와 같은 명령어 한줄로 제작할 수 있습니다.
